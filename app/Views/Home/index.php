...
<title>SGP::PMU-PAV::Projeto App</title>
...
<!-- Plugins css -->
<link rel="stylesheet" href="<?php echo site_url('assets')?>/plugins/charts-c3/c3.min.css"/>

<!-- Core css -->
<link rel="stylesheet" href="<?php echo site_url('assets')?>/css/main.css"/>
<link rel="stylesheet" href="<?php echo site_url('assets')?>/css/theme1.css"/>
</head>
...
<script src="<?php echo site_url('assets')?>/bundles/lib.vendor.bundle.js"></script>
<script src="<?php echo site_url('assets')?>/js/fontawesome/script.js"></script>

<script src="<?php echo site_url('assets')?>/bundles/apexcharts.bundle.js"></script>
<script src="<?php echo site_url('assets')?>/bundles/counterup.bundle.js"></script>
<script src="<?php echo site_url('assets')?>/bundles/knobjs.bundle.js"></script>
<script src="<?php echo site_url('assets')?>/bundles/c3.bundle.js"></script>

<script src="<?php echo site_url('assets')?>/js/core.js"></script>
<script src="<?php echo site_url('assets')?>/js/page/project-index.js"></script>
</body>
